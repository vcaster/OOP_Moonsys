...
class User
{
    ...
    {
        $this->db->query('SELECT * FROM empdetails e INNER JOIN positions p ON e.positionid=p.positionid INNER JOIN departments d ON e.deptid=d.deptid WHERE email = :email ');
