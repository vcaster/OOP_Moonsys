...
<!-- Bootstrap Core CSS -->
<link href="<?php echo URLROOT ?>/css/bootstrap(2).css" rel='stylesheet' type='text/css' />

<!-- Custom CSS -->
<link href="<?php echo URLROOT ?>/css/style(2).css" rel='stylesheet' type='text/css' />
...
<!-- side nav css file -->
<link href='<?php echo URLROOT ?>/css/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->

 <!-- js-->
<script src="<?php echo URLROOT ?>/js/jquery-1.11.1.min(2).js"></script>
<script src="<?php echo URLROOT ?>/js/modernizr.custom.js"></script>
...
<script src="<?php echo URLROOT ?>/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					...
					<script src="<?php echo URLROOT ?>/js/owl.carousel.js"></script>
						<script>
							$(document).ready(function() {
