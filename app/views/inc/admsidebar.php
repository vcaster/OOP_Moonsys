  ...
  <nav class="navbar navbar-inverse">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="<?php echo URLROOT ?>/admins/employees">
    ...
    <!-- <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="general.html"><i class="fa fa-angle-right"></i> Reports</a></li>
              <li><a href="icons.html"><i class="fa fa-angle-right"></i> Annoucements</a></li>
              <li><a href="buttons.html"><i class="fa fa-angle-right"></i> Documents</a></li>
