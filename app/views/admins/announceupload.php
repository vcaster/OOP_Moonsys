    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <ul class="nav nav-tabs">
                            <br><br><br>
                <li class="active"><a data-toggle="tab" href="#home">File Upload</a></li>
              </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                                ...
                                <form action="<?php echo URLROOT; ?>/admins/announceupload/<?php echo $data['id']; ?>" method="post" ">
                                  ...
                                  <!-- Grid row -->
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                                <!-- Material input -->
                                                <div class="md-form form-group">
                                                        <input type="text" class="form-control" name="announce" id="inputPhoneMD" value="">
                                                ...
                                                <div class="md-form form-group">
                                                    <!-- <label for="inputGenderDateMD">Gender</label> -->
                                                        <select class="mdb-select colorful-select dropdown-info" name="dept">
                                                            <?php foreach ($data['dept'] as $depts) : ?>
