    ...
    <div class="main-page">
            <div class="tables">
                ...
                <div class="panel-body widget-shadow">
                    <h4>Reports</h4>
                    <a href="<?php echo URLROOT; ?>/employees/reportupload/<?php echo $_SESSION['user_id']; ?>"><span class="btn btn-primary btn-sm pull-right"><span class="fa fa-plus"></span> Add</span></a>
