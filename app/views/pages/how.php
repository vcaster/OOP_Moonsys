<?php require APPROOT . '/views/inc/headernrm.php'; ?>
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Some Info</span>How It works</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-6 work-grid-left">
                        <img src="<?php echo URLROOT ?>/images/g1.jpg" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="row my-5">

                    <div class="col-lg-6 work-grid-left">
                        <img src="<?php echo URLROOT ?>/images/g7.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-lg-6 work-grid-right">
                        <div class="work-info">
                            <h5>
                            ...
                            <h4 class="post my-3">Specify & Search Your Job</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut consectetur adipisicing elit sedc labore et dolore magna aliqua uta enim ad minim.. </p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-6 work-grid-right">
                        <div class="work-info">
                            ...
                            <h4 class="post my-3">Apply For Job</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut consectetur adipisicing elit sedc labore et dolore magna aliqua uta enim ad minim.. </p>
                        </div>
                    </div>
                    <div class="col-lg-6 work-grid-left">
                        <img src="<?php echo URLROOT ?>/images/g3.jpg" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row populor_category_grids mt-5">
                    <div class="col-md-3 category_grid">
                        <div class="view view-tenth">
                            ...
                            <div class="mask">
                                <a href="#">
                                    <img src="<?php echo URLROOT ?>/images/p1.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 category_grid">
                        <div class="view view1 view-tenth">
                            ...
                            <div class="mask">
                                <a href="#">
                                    <img src="<?php echo URLROOT ?>/images/p2.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 category_grid">
                        <div class="view view2 view-tenth">
                            ...
                            <div class="mask">
                                <a href="#">
                                    <img src="<?php echo URLROOT ?>/images/p3.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 category_grid">
                        <div class="view view3 view-tenth">
                            ...
                            <div class="mask">
                                <a href="#">
                                    <img src="<?php echo URLROOT ?>/images/p4.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="parent-chart">
                        <div class="level lev-one top-level">
                            <div class="flow-position">
                                <img src="<?php echo URLROOT ?>/images/s1.jpg" alt=" " class="img-fluid rounded-circle">
                                <br>
                        ...
                        <div class="flow-chart">
                            <div class="level lev-two last-lev">
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s2.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s3.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s4.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s5.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s6.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s7.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
                                ...
                                <div class="flow-position">
                                    <img src="<?php echo URLROOT ?>/images/s8.jpg" alt=" " class="img-fluid rounded-circle">
                                    <br>
